...
const Resume = () => {
    ...
    return (
        <div className="max-w-screen-lg mx-auto p-5 shadow-2xl">
            ...
            <div className="flex flex-col md:flex-row md:gap-40 mt-5 md:mt-20">
            ...
            <div className="mt-5 md:mt-20">
                ...
                <div className=" grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div>
                        <h1 className=" text-lg md:text-xl font-bold">Medical Camp Management (MERN Stack)</h1>
                        <a href="https://github.com/mihir-x/medical-camp-management-project" className="text-blue-800">GitHub Link</a>
                        <a href="https://luminous-sherbet-6eb0c1.netlify.app" className="text-blue-800 ml-5">Live Link</a>
                    ...
                    <div>
                        <h1 className=" text-lg md:text-xl font-bold">Blog Hub (MERN Stack)</h1>
                        <a href="https://github.com/mihir-x/my-blog-website-assignment" className="text-blue-800">GitHub Link</a>
                        <a href="https://gorgeous-kitten-b026ab.netlify.app" className="text-blue-800 ml-5">Live Link</a>
                        <p className="font-bold">Features:</p>
                        <ul>
                            <li>Database integration with mongoDB</li>
                    ...
                    <div>
                        <h1 className=" text-lg md:text-xl font-bold">Medical Camp Management (MERN Stack)</h1>
                        <a href="https://github.com/mihir-x/automotive-brand-shop-project" className="text-blue-800">GitHub Link</a>
                        <a href="https://celadon-croissant-bebbb3.netlify.app" className="text-blue-800 ml-5">Live Link</a>
                        <p className="font-bold">Features:</p>
                        <ul>
                            <li>Database integration with mongoDB</li>
